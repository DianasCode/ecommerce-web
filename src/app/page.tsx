...
SHOP
      ...
      <nav className="hidden items-center gap-8 text-sm font-medium md:flex">
        ...
        <Link href="/categories" className="hover:text-zinc-500">
          Categories
        </Link>
      </nav>
    ...
    <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
      <div className="max-w-3xl">
        ...
        <p className="mt-8 max-w-xl text-lg leading-8 text-zinc-600">
          ...
          from technology and fashion to home and sports.
        </p>
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          ...
          <Link
            href="/categories"
            className="rounded-full border border-zinc-300 bg-white px-7 py-3.5 text-sm font-medium transition hover:bg-zinc-100"
          >
            Browse categories
          </Link>
        </div>
  ...
  <section className="border-t border-zinc-200 bg-zinc-50">
    <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
      <div>
        <p className="text-sm font-medium text-zinc-500">Our selection</p>
        <h2 className="mt-2 text-3xl font-semibold tracking-tight">
          Featured products
        </h2>
      </div>
  ...
  <footer className="border-t border-zinc-200">
    <div className="mx-auto flex max-w-7xl flex-col gap-3 px-6 py-8 text-sm text-zinc-500 sm:flex-row sm:items-center sm:justify-between lg:px-8">
      ...
      <p>Built as a production-ready e-commerce platform.</p>
    </div>
  </footer>
</main>
